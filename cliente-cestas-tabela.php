<div class="box-body table-responsive">
    <table class="table table-hover">
        ...
        <?php
        $cestas = listaCestasCliente($_SESSION['usuario_logado']['cliente_id']);
    ...
    <div class="col-sm-12 pull-right">
        <a style="width: 20%;" href="cliente-monte-sua-cesta.php" type="button" class="btn btn-md btn-primary">Nova cesta</a>
    </div>
</div>