        ...
        <div class="container">
            ...
            <div class="login-box">
                ...
                <div class="box-default">
                    <form action="fornecedor-adicionar.php" method="post">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" id="razao" name="razao" placeholder="Nome" required="requiored">
                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" id="cnpj" name="cnpj" placeholder="CNPJ" required="requiored">
